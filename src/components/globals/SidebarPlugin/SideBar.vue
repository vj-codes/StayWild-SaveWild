      ...
      >
        ...
        <ul class="navbar-nav mb-md-3">
          ...
          <li class="nav-item">
            <a
              class="nav-link"
              href="https://demos.creative-tim.com/vue-argon-dashboard/documentation/components/globals/alerts.html"
            >
...
<script>
import NavbarToggleButton from "@/components/globals/NavbarToggleButton";
